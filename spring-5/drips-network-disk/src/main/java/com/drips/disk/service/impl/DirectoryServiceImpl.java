...
//
//    //创建目录
//    public Directory mkdir(String name, String pid, HttpSession httpSession) {
...
////            pid = "root";
//            pid = "2c92ddce6029631a01602964c26e0000";
//        }
//        validateName(name, pid);
//        //保存记录
//        Directory dir = new Directory();
//        dir.setName(name);
//        dir.setCreatorId(currentUID);
//        dir.setCreatorName(creatorName);
//        dir.setPid(pid);
//        dir.setCreateTime(new Date());
//        dir.setModifyTime(new Date());
//        Serializable id = dataset.save(dir);
//        //关系维护
////        if(! pid.equals("root")) {
//        Directory parentDir = dataset.get(pid, Directory.class);
//        if (parentDir == null) {
//            throw new RuntimeException("创建目录失败：父目录不存在");
//        }
//        List<Directory> dirList = parentDir.getDirectoryList();
//        if (dirList == null) {
//            dirList = new ArrayList<>();
//        }
//        dirList.add(dir);
//        parentDir.setDirectoryList(dirList);
//        dataset.update(parentDir);
////        }
//        return dataset.get(id, Directory.class);
//    }
//
//    public void validateName(String name, String pid) throws RuntimeException {
//        //判断name是否有敏感词，有则抛错
//
//        //查找同一级别下是否有相同文件的目录或文件
//        List<String> dirNames = listDirNames(pid);
//        if (dirNames != null &&dirNames.stream().anyMatch(e-> e.equalsIgnoreCase(name))) {
//            throw new RuntimeException("创建目录失败：同目录下存在相同名称目录");
//        }
//        List<String> docNames = documentServiceImpl.listDocNames(pid);
//        if (docNames != null && docNames.stream().anyMatch(e->e.equalsIgnoreCase(name))) {
...
//    public List<String> listDirNames(String dirId) {
//        List<String>        dirNames = null;
//        BaseRepository baseRepository=baseRepositoryMaster.repository(Directory.class);
//        Map<String, Object> paramMap = new HashMap<>();
//        paramMap.put("pid", dirId);
//        List<Map> map = null;
//        try {
//            map = queryService.query("listDirNameByPid", paramMap, Map.class, 0, 0);
//        } catch (Exception e) {
//            e.printStackTrace();
//        }
//        if (map != null && !map.isEmpty()) {
//            dirNames = map.stream().filter(e -> e != null).map(e -> (String) e.get("dirName")).collect(Collectors.toList());
//        }
